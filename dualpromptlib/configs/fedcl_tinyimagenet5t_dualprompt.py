...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--classes_per_task', default=40, type=int, help='number of rounds per task')
    subparsers.add_argument('--available_classes', default=24, type=int, help='number of available classes per task')
