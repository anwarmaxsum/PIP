...
def get_args_parser(subparsers):
    ...
    # subparsers.add_argument('--output_dir', default='./output/', type=str, help='output dir')
    subparsers.add_argument('--dataset', default='Split-ImagenetSubset', type=str, help='dataset name')
    ...
    #For Federated CL setting
    subparsers.add_argument('--num_tasks', default=10, type=int, help='number of tasks')
    subparsers.add_argument('--num_clients', default=30, type=int, help='number of all clients')
    subparsers.add_argument('--local_clients', default=10, type=int, help='number of selected clients per round')
    subparsers.add_argument('--rounds_per_task', default=10, type=int, help='number of rounds per task')
    subparsers.add_argument('--classes_per_task', default=10, type=int, help='number of rounds per task')
    subparsers.add_argument('--available_classes', default=6, type=int, help='number of available classes per task')
