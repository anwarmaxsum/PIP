...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--num_tasks', default=20, type=int, help='number of tasks')
    ...
    subparsers.add_argument('--rounds_per_task', default=5, type=int, help='number of rounds per task')
    subparsers.add_argument('--classes_per_task', default=5, type=int, help='number of rounds per task')
    subparsers.add_argument('--available_classes', default=3, type=int, help='number of available classes per task')
