...
def train_and_evaluate2(model: torch.nn.Module, model_without_ddp: torch.nn.Module, original_model: torch.nn.Module,
                    model2: torch.nn.Module, model_without_ddp2: torch.nn.Module, original_model2: torch.nn.Module,  
                    criterion, data_loader: Iterable, optimizer: torch.optim.Optimizer, lr_scheduler, device: torch.device, 
                    class_mask=None, args = None,):
...
def train_and_evaluate_pertask(model: torch.nn.Module, model_without_ddp: torch.nn.Module, original_model: torch.nn.Module,
                    model2: torch.nn.Module, model_without_ddp2: torch.nn.Module, original_model2: torch.nn.Module,  
                    criterion, data_loader: Iterable, optimizer: torch.optim.Optimizer, lr_scheduler, device: torch.device, 
